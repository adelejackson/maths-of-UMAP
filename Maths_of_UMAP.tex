...
UMAP (Uniform Manifold Approximation and Projection) is
...
assume a substantial background in topology and category theory.  We
will give a brief exposition of the theory without (hopefully) assuming too much
prior knowledge.  We would highly recommend reading further in category
theory and algebraic topology if you are interested in these types
...
into $\RR^N$ by some injective map $\phi: M\to \RR^N$. See
