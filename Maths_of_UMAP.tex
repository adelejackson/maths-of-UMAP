...
%\usepackage[bottom=1.5in, left=1.25in, right=1.25in, top=1.5in]{geometry}
...
%We consider simplicial sets rather than Delta complexes as there is a translation between the category of finite simplicial sets and the category of finite extended-pseudo-metric spaces.
